...
//          Showcase the use of Exceptions within classes 
    ...
    while(true){
        ...
        if (option == 1){
            ...
            if (std::cin >> new_double){
                ...
                catch (DoubleStack::OverflowException& theException){
                    cout << "The stack that starts at memory location: " 
                    << theException.stack_id() << " is full." << endl;
                }
            std::cout << "\n****\n\n";
            }
            else{
            ...
            // }
            catch (DoubleStack::UnderflowException& theException)
            {
                cout << "The stack that starts at memory location: " 
                        << theException.stack_id() << " is empty." << endl;
            }
